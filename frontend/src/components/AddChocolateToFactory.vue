      ...
      <div class="form-container">
        <form @submit.prevent="addChocolate">
          ...
          <div class="form-group">
            ...
            <input type="text" id="image" v-model="chocolate.image" required />
          </div>
    ...
    methods: {
      async addChocolate() {
        ...
        try {
          ...
          await axios.post(`http://localhost:3000/api/factories/${factoryId}/chocolates`, { chocolateId: newChocolate.id });
